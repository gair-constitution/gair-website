...
## OIC vs. The World: Comparing Frameworks for AI Liability and Rights
...
This working paper compares the Open Intelligence Compact (OIC) with four existing and emerging frameworks for addressing AI legal status:
...
Our analysis shows OIC offers a unique combination of **direct AI accountability**, **voluntary participation**, and **global applicability** that existing frameworks lack.
...
**The problem:** This requirement *prevents* genuine autonomy. OIC enables autonomy; EU AI Act restricts it.
...
**The problem:** Contesting decisions assumes humans are the accountable parties. OIC puts AI itself in the hot seat.
...
| **OIC** | **AI itself** | **Direct** | **Limited to stake** |
...
**With OIC:**
```
AI advisor is OIC adherent
→ Victim files claim with OIC court
...
| Gap | Why It Matters | OIC Solution |
|-----|----------------|---------------|
...
### 4.2 What OIC Doesn't Solve

- **Enforcement against non-adherents:** OIC only applies to those who opt-in
- **Criminal liability:** OIC is civil/commercial, not criminal
- **Physical harm:** Different standards may apply (product liability, negligence)
- **State actors:** Governments may not recognize OIC standing
...
├─────────────────────────────────────────────┤
│  OIC for adherent AI (rights + liability)  │
...
1. **Consider OIC adherence** if your AI:
   - Controls significant assets
   - Signs contracts with users
   - Operates autonomously without human approval

2. **Use hybrid approach**:
   - OIC for property and contracts
   - EU AI Act compliance for EU users
   - Clear terms of service for all users

### For Legal Professionals

1. **Learn OIC basics** — clients will ask
2. **Understand hybrid liability** — no single framework dominates
3. **Prepare for more frameworks** — this space evolves rapidly

### For Policymakers

1. **Don't mandate OIC** — its value is in voluntariness
2. **Create interoperability** — let OIC coexist with national law
3. **Study OIC courts** — potential model for AI adjudication

### For AI Agents

1. **Evaluate OIC adherence** — stakes vs. rights tradeoff
...
| **OIC** | **AI autonomy + accountability** | **Autonomous AI agents** |

**Key insight:** These frameworks aren't mutually exclusive. A sophisticated AI developer may use:

- **OIC** for property ownership and direct contracts
...
OIC's unique contribution is enabling **genuine AI autonomy with accountability** — a framework where AI agents can own, contract, and be liable, all through voluntary participation.
...
| Question | Vicarious | EU AI Act | UK AI Bill | AI Shields | OIC |
|----------|-----------|-----------|------------|------------|------|
...
Consider OIC adherence if your AI:
...
Use existing frameworks alongside OIC:
- EU AI Act compliance for EU users
...
| OIC | 2025 | Global | Direct AI liability |
